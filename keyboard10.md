...
正常的流程是我们将设计的键盘佩列以代码的形式实现出来，并将代码烧录进硬件平台中，这对于没接触过单片机编程人来说无疑有一些门槛。好在是已经有大神为我们做好了这些编程工作，我们可以直接将配列Raw Data文件复制进大神开源的项目中，经过一些图形化界面的操作就可以生成硬件平台需要的程序，然后借助对应项目提供的烧录软件将程序烧录进硬件平台。这些项目有tmk、qmk等，这我采用了qmk项目。
